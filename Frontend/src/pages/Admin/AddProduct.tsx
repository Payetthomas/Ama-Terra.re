...
const AddProduct = () => {
    ...
    useEffect(() => {
        if (id) {
            axios
                .get(`http://localhost:1818/api/product/${id}`)
                .then((res) => {
                    const {
                        title,
                        description,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (id) {
                await axios.put(
                    `http://localhost:1818/api/product/${id}`,
                    formData,
                    {
                ...
                await axios.post(
                    "http://localhost:1818/api/product",
                    formData,
                    {
                        headers: { "Content-Type": "multipart/form-data" },
                    },
    ...
    async function fetchCategories() {
        try {
            const result = await axios.get(
                "http://localhost:1818/api/category",
            );
    ...
    const handleAddCategory = async () => {
        try {
            await axios.post("http://localhost:1818/api/category", {
                name: newCategory,
            });
            setNewCategory("");
    ...
    async function fetchSuppliers() {
        try {
            const result = await axios.get(
                "http://localhost:1818/api/supplier",
            );
